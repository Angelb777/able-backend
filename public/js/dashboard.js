...
function renderPoliceSavedConfig(config) {
  ...
  target.innerHTML = `<section style="border:1px solid #777;padding:12px;margin:12px 0">
    ...
    ${config.routingConfigured ? "" : '<p style="color:#a00"><strong>Valhalla no configurado:</strong> define GROUND_ROUTING_PROVIDER=valhalla y VALHALLA_BASE_URL con la direccion interna del servicio. Las rutas de pago estan desactivadas.</p>'}
